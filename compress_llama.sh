...
python SVDLLM.py --model Qwen/Qwen3-8B --selection_method topk --selection_nsamples 16 \
...
# python SVDLLM.py --step 4 --model_path /nfs/scistore19/alistgrp/stang/SVD-LLM/mistralai_Mistral_7B_v0.1_whitening_only_sem_0.6.pt
