...
# python SVDLLM.py --model meta-llama/Llama-3.1-8B --selection_method topk --selection_nsamples 32 \
#     --sem_merge_budget 16 --sem_top_candidates 4 --sem_lambda 1e-2 --step 1 --ratio 0.2 --whitening_nsamples 256 \
#     --dataset wikitext2 --seed 3 --model_seq_len 2048 --save_path .
...
python SVDLLM.py --step 4 --model meta-llama/Llama-3.1-8B  --model_path /nfs/scistore19/alistgrp/stang/SVD-LLM/meta_llama_Llama_3.1_8B_whitening_only_0.8.pt
# --model_path /nfs/scistore19/alistgrp/stang/SVD-LLM/Qwen_Qwen3_8B_whitening_only_0.6.pt
