...
python SVDLLM.py --model mistralai/Mistral-7B-v0.1 --step 1 --bi_whitening --ratio 0.2 --whitening_nsamples 256 --dataset wikitext2 --seed 3 --model_seq_len 2048 --save_path .
