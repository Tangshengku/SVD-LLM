#!/bin/bash
export TRANSFORMERS_CACHE=/nfs/scistore19/alistgrp/huggingface/hub/shengkun

# example of compressing LLaMA-7B with SVDLLM
FINE_TUNE_PATH="."
# run data whitening with 20% compression ratio
python SVDLLM.py --model Qwen/Qwen3-8B --selection_method topk --selection_nsamples 32 \
    --sem_merge_budget 16 --sem_top_candidates 4 --sem_lambda 1e-2 --step 1 --ratio 0.4 --whitening_nsamples 256 \
...
# python SVDLLM.py --step 4 --model Qwen/Qwen3-8B  --model_path original
