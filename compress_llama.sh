...
python SVDLLM.py --model mistralai/Mistral-7B-v0.1 --step 1 --bi_whitening --ratio 0.4 --whitening_nsamples 256 --dataset wikitext2 --seed 3 --model_seq_len 2048 --save_path .
...
# python SVDLLM.py --step 4 --model_path /nfs/scistore19/alistgrp/stang/SVD-LLM/mistralai_Mistral_7B_v0.1_whitening_only_0.6.pt
