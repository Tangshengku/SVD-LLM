...
python SVDLLM.py --model mistralai/Mistral-7B-v0.1 --selection_method task_aware_diag --selection_nsamples 128  --selection_candidate_extra 32 --step 1 --ratio 0.4 --whitening_nsamples 256 --dataset wikitext2 --seed 3 --model_seq_len 2048 --save_path .
