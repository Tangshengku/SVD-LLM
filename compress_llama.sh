...
# python SVDLLM.py --dataset mix:wikitext2,evol-codealpaca,tulu-math --model mistralai/Mistral-7B-v0.1 --step 1 --ratio 0.4 --whitening_nsamples 256 --seed 3 --model_seq_len 2048 --save_path .
...
python SVDLLM.py --step 4 --model_path /nfs/scistore19/alistgrp/stang/SVD-LLM/evo_output_mistral_rank_step128_kl_400generation/mistralai_Mistral_7B_v0.1_evo_svd_0.4.pt
